                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="exam_update.php" method="POST">
<?php
include "db.php";

$exid = $_GET['exid'];
$sql = "select * from title where exid='$exid'";
...
?>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="exname" value="<?php echo $row['exam_name'];?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Time:</label>
                                            <input class="form-control" name="time" value="<?php echo $row['etime'];?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Total:</label>
                                            <input class="form-control" name="total" value="<?php echo $row['total'];?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Marks(each question):</label>
                                            <input class="form-control" name="mark" value="<?php echo $row['mark'];?>">
                                        </div>
<?php 
}
?>
