...
<?php
    ...
    $sql="select name,mail from user_details";
...
?>
                                            <tr>
                                                ...
                                                <td><a href="student_view.php?mail=<?php echo $row['mail'];?>">View</a></td>
                                                <td><a href="exam_details.php?mail=<?php echo $row['mail'];?>">View</a></td>
                                            </tr>
<?php        
    }
?>
